...
class Decoder_Block(nn.Module):
    def __init__(self, in_c, out_c):
        ...
        self.r1 = InvertedResidual(in_c[0]+in_c[1], out_c, stride=1,expand_ratio=1)
...
class mobileunetv2pp(nn.Module):
    def __init__(self):
        super().__init__()

        self.c1 = Stem_Block(1, 16, stride=1)
        self.c2 = InvertedResidual(16, 32, stride=2,expand_ratio=6)
        self.c3 = InvertedResidual(32, 64, stride=2,expand_ratio=6)
        self.c4 = InvertedResidual(64, 128, stride=2,expand_ratio=6)
